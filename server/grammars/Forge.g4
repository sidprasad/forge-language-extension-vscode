...
alloyModule: importDecl* paragraph* | evalDecl*;
...
expr18: const | qualName | AT_TOK name | BACKQUOTE_TOK name | THIS_TOK 
      | LEFT_CURLY_TOK quantDeclList blockOrBar RIGHT_CURLY_TOK 
      | LEFT_PAREN_TOK expr RIGHT_PAREN_TOK | block | sexpr;
...
bindRHSProduct: LEFT_PAREN_TOK bindRHSProduct RIGHT_PAREN_TOK 
              | bindRHSProduct (COMMA_TOK | ARROW_TOK) bindRHSProductBase 
              | bindRHSProductBase;
